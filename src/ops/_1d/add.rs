...
pub trait ArrayAdd<T, const N: usize>: Map<T, N>
{
    ...
    where
        T: Add<Rhs>,
        Rhs: Copy;
    fn add_all_ref<'a, Rhs>(&'a self, rhs: Rhs) -> [<&'a T as Add<Rhs>>::Output; N]
    where
        &'a T: Add<Rhs>,
        Rhs: Copy;
    ...
    where
        T: Add<Rhs>,
        Rhs: Copy;
    async fn add_all_ref_async<'a, Rhs>(&'a self, rhs: Rhs) -> [<&'a T as Add<Rhs>>::Output; N]
    where
        &'a T: Add<Rhs>,
        Rhs: Copy;
    ...
    where
        T: Add<Rhs::Elem>,
        Rhs: ArrayForm<N>;
    fn add_each_ref<'a, Rhs>(&'a self, rhs: Rhs) -> [<&'a T as Add<Rhs::Elem>>::Output; N]
    where
        &'a T: Add<Rhs::Elem>,
        Rhs: ArrayForm<N>;
    ...
    where
        T: Add<Rhs::Elem>,
        Rhs: ArrayForm<N>;
    async fn add_each_ref_async<'a, Rhs>(&'a self, rhs: Rhs) -> [<&'a T as Add<Rhs::Elem>>::Output; N]
    where
        &'a T: Add<Rhs::Elem>,
        Rhs: ArrayForm<N>;
}
